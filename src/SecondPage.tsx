...
export default function SecondPage(): React.ReactElement{
    return (
        <>
            ...
            <Link to="/third" className="select-none block bg-pink-500 text-center mt-4 text-white rounded-full hover:bg-pink-600 transition-colors duration-300 py-2 px-6">Next</Link>
        </>
